...
public class SetNextRule extends Rule {
    ...
    public void end(String namespace, String name) throws Exception {
        ...
        if (parent == null) {
            digester.log.info("[SetNextRule]{" + digester.match + "} Call [NULL PARENT]." + methodName + "(" + child + ")");
        } else {
            digester.log.info("[SetNextRule]{" + digester.match + "} Call " + parent.getClass().getName() + "." + methodName + "(" + child + ")");
        }
