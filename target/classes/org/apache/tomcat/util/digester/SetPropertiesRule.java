...
public class SetPropertiesRule extends Rule {
    ...
    public void begin(String namespace, String theName, Attributes attributes)
        ...
        //把ObjectCreateRule创建的对应 弹出栈
        Object top = digester.peek();
        if (top != null) {
            digester.log.info("[SetPropertiesRule]{" + digester.match + "} Set " + top.getClass().getName() + " properties");
        } else {
            digester.log.info("[SetPropertiesRule]{" + digester.match + "} Set NULL properties");
        }
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            digester.log.info("[SetPropertiesRule]{" + digester.match + "} Setting property '" + name + "' to '" + value + "'");


            //使用IntrospectionUtils.setProperty(top, name, value) 来设置对象的属性值
