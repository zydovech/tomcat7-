...
public class Digester extends DefaultHandler2 {
     ...
     * will be provided. 这个rules的实现是RulesBase
     */
    ...
    public SAXParser getParser() {
        ...
        // Create a new parser
        try {
            //getFactory 返回 SAXParserFactory 然后创建SAXParser
    ...
    public void addRule(String pattern, Rule rule) {
        ...
        /*
         * getRules() 获取RulesBase的实例
         * RulesBase中存在rules（所有的rule集合）和 cache（HashMap，以pattern为key）
         */
    ...
    public void addRuleSet(RuleSet ruleSet) {
        ...
        if (newNamespaceURI == null) {
            log.info("addRuleSet() with no namespace URI");
        } else {
            log.info("addRuleSet() with namespace URI " + newNamespaceURI);
        }
