...
public class StandardContext extends ContainerBase implements Context, NotificationEmitter {
   ...
   /**
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (getLoader() == null) {
           //WebappLoader对WebappClassLoader的包装
            WebappLoader webappLoader = new WebappLoader(getParentClassLoader());
            //控制WebappClassLoader 的类加载顺序 默认为false 即打破双亲委派模型
            webappLoader.setDelegate(getDelegate());
            //设置该容器关联的webappLoader
        ...
        log.info("Processing standard container startup");
        ...
        try {
            ...
            if (ok) {
                ...
                if (contextManager != null) {
                   ...
                   log.info(sm.getString("standardContext.manager", contextManager.getClass().getName()));
